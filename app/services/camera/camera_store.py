...
class CameraStore:
    ...
    #===========================
    def put_img_raw_to_queue(self, img_arr, year, month, day , hour, min, sec, msec, lat, lon, alt, numSat):
        data = RawImageData(img_arr, year, month, day , hour, min, sec, msec, lat, lon, alt, numSat)
        self.img_raw_queue.put(data)
        return
